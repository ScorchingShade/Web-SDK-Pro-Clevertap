...
CleverTap Web SDK is available as an npm package or as a script to manually add to your website. This is a demo app showcasing some functionality of Clevertap SDK in a react app, such as web push and onUserLogin.
